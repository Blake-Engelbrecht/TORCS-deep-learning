...
context:    TORCS project, team 1 in CSC450, taught by Dr. Razib Iqbal. 
            Interface between client and gym_torcs server
...
#----------------------------------- import here --------------------------------------
import sys
sys.path.append('/home/khaled/anaconda3/envs/turinglab/gym')
import gym
...
class TorcsEnv:
    ...
    def step(self, u):
        ...
        # My reward function that checks if the agent has moved or got stuck 
        if self.counter == 0:
